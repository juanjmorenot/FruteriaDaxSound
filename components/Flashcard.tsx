                    ...
                    <div className={`[grid-area:1/1] backface-hidden rotate-y-180 flex flex-col p-6 rounded-[2rem] shadow-xl shadow-stone-500/10 bg-white border border-stone-200`}>
                        <div className="flex-grow">
                            ...
                            <div className="mb-4">
                                ...
                                <pre className="text-sm bg-neutral-100 p-4 rounded-xl mt-1 text-stone-700 whitespace-pre-wrap break-words"><code>{formula.syntax}</code></pre>
                            </div>
                            <div>
                                <h3 className={`text-lg font-bold ${theme.color}`}>Ejemplo de la Frutería:</h3>
                                <pre className="text-sm bg-neutral-100 p-4 rounded-xl mt-1 text-stone-700 whitespace-pre-wrap break-words"><code>{formula.example}</code></pre>
                            </div>
                        </div>
                    </div>
                </div>
