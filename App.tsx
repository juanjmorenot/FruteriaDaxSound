...
const App: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-neutral-50 text-stone-700 flex flex-col">
            <Header compact={selectedMode !== null} />
                    ...
                    <div>
                         <div className="mb-6 text-left w-full max-w-4xl mx-auto">
                            <button
                                ...
                                className="inline-flex items-center gap-2 px-5 py-2 bg-white border border-stone-300 rounded-full shadow-sm text-stone-600 font-bold hover:bg-orange-50/80 transition transform hover:scale-105"
